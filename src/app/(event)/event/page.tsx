    ...
    <main className="flex flex-col px-3 gap-2 min-h-screen">
      ...
      <div className="flex flex-row justify-around items-center">
        <Button
          ...
          className={cn("w-full border-b-2 border-transparent rounded-none",{" border-primary-purple-101": activeTab === 'self'})}
        >Created</Button>
        <Button
          size="small"
          variant="tinted"
          onClick={() => activeTab !== 'assigned' && router.push('/event?t=assigned')}
          className={cn("w-full border-b-2 border-transparent rounded-none",{"border-primary-purple-101": activeTab === 'assigned'})}
        >Assigned</Button>
      </div>
