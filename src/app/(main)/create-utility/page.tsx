  ...
  return (
    <main className="flex flex-col px-3 gap-5 min-h-screen">
      ...
      <section className="flex flex-col w-full gap-3">
        <Link href={'/event/create'} className="w-full flex flex-row items-center justify-center bg-primary-blue-500 dark:bg-neutral-800 p-5 gap-2 rounded-lg shadow-lg">
